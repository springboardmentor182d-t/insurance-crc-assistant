...
from src.recommendations_profile_preferences.models.fire_progress import FireProgress
from src.recommendations_profile_preferences.schemas.fire_progress import FireProgressRequest
