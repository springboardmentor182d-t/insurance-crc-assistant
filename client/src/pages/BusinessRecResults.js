...
export default function BusinessRecResults() {
  ...
  useEffect(() => {
    if (!state) {
      navigate("/businessrecommendation");
      return;
    }

    axios
      .post("/api/business/recommendations", state)
  ...
  if (!sortedPolicies.length) {
    return (
      <div className="text-center mt-20">
        <h2 className="text-xl font-bold">No matching business policies found</h2>
        <button
          onClick={() => navigate("/businessrecommendation")}
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-500 mt-2">
          Plans tailored to your business profile
        </p>
      </div>
